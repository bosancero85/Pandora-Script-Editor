"""Pandora®-Cyberpunk-Stylesheet für den Environment & Dependency Manager.

Identische Farb-/Struktursprache wie bei den anderen Pandora-Werkzeugen
(Crypto Utility, SQL Config Editor, UI Asset & Color Studio: dunkler
Hintergrund, Cyan-Akzent #00e5ff, Pink-Akzent #ff2a6d), damit sich das
Tool nahtlos in die bestehende Pandora-Werkzeugleiste einfügt.
"""
PANDORA_QSS = """
QWidget {
